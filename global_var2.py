...
wwin = "\\\\serv2.icerasemi.com\\home\\gcflab\\workspace\\callbox-test\\"
...
for branch in BRANCH_4TEST:
    build_dir.append(wlinux+"%s.br/product/datacard/modem/build/"%branch)
    p4path.append("//software/"+branch+"/")
    MODEM_BINARY_LOC.append(wwin+"software\\%s.br\\product\\datacard\\modem\\build\\dxp-%s-obj\\EV4\\"%(branch,variant))
...
auto_callbox_loc = r"C:\Documents and Settings\Administrator\Desktop\auto_callbox"
SYS_STATUS = ['OK','DOWNLOAD_ONLY','ERROR']
BINARY_LIB = "\\\\serv2.icerasemi.com\\home\\gcflab\\workspace\\binary_lib\\"
...
STATUS_OK = "Ok"; STATUS_REGRESSION = "Reg"; STATUS_ASSERT = "Assert"; STATUS_ERROR = "Error"
